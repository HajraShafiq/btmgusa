...
<head>
<meta charset="UTF-8" />
<title>Agile & AI Scrum Master (Beginner → Intermediate) | BTMG USA</title>
...
<style>
/* =========================================================
   BTMG USA — COURSE PAGE THEME (REPLICATED)
========================================================= */
:root{
  --btmg-teal:#004F59;
...
.btn.primary{background:var(--btmg-teal);color:#fff}
.btn.primary:hover{background:var(--btmg-teal-600)}
.btn.secondary{background:#fff;color:var(--btmg-teal)}
...
/* ================= FAQ ================= */
.faq strong{color:var(--btmg-teal)}

/* ================= CTA + FORM (PYTHON STYLE) ================= */
...
<div class="topbar">
    <div class="container d-flex justify-content-between align-items-center">
        ...
        <div>
            ...
            <i class="bi bi-envelope me-1" style="color: #F47B1E"></i> <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="71181f171e3113051c160402105f121e1c">[email&#160;protected]</a> &nbsp;&nbsp;
...
<section class="hero" id="top">
  <div class="container">
    ...
    <div class="hero-grid">
      <div>
        <h1>Agile & AI Scrum Master<br>(Beginner → Intermediate)</h1>
           <p class="lead">Date:00-00-0000<br></p>
        <p class="lead">
          A fast-track, instructor-led program that prepares professionals to lead Agile teams using Scrum
          and modern AI-assisted tools. Built for job seekers, career changers, and working professionals.
        </p>

        <div class="hero-meta">
          <span class="pill"><span class="dot"></span> 2 Days</span>
          <span class="pill"><span class="dot"></span> 6 Hours / Day</span>
      ...
      <div class="snapshot">
        ...
        <div class="snapshot-desc">
         <b> Certificate Included </b><br>• Instructor-led sessions <br>• Hands-on simulation <br>•
          Daily recap & knowledge check
        </div>

        <div class="snapshot-pills">
          <div class="snapshot-pill"><span>✓</span>70% Practice</div>
          <div class="snapshot-pill"><span>✓</span>Live Facilitation</div>
          <div class="snapshot-pill"><span>✓</span>Real Scrum Scenarios</div>
        </div>
  ...
  <div class="container" id="section2">
    ...
    <div class="grid-3">
      <div class="card">
        ...
        <p class="lead" style="font-size:15px;margin:0">
          Build a practical Agile mindset and understand Scrum as an enterprise delivery framework.
        </p>
      </div>
      ...
      <div class="card">
        ...
        <p class="lead" style="font-size:15px;margin:0">
          Master facilitation, coaching, team health practices, and delivery flow in real scenarios.
        </p>
      </div>
      ...
      <div class="card">
        ...
        <p class="lead" style="font-size:15px;margin:0">
          Use AI tools to improve planning, reporting, insights, and documentation—without losing judgment.
        </p>
      </div>
    </div>
  </div>
  ...
  <div class="container" id="section3">
    ...
    <div class="grid-3">
      <div class="card">
        ...
        <ul class="clean">
          <li>Understand Scrum roles, events, and artifacts</li>
          <li>Run planning, daily Scrum, review, and retrospective</li>
          <li>Support backlog refinement and sprint readiness</li>
        </ul>
      </div>
      ...
      <div class="card">
        ...
        <ul class="clean">
          <li>Facilitate team collaboration and conflict resolution</li>
          <li>Remove blockers and reduce delivery friction</li>
          <li>Measure flow, throughput, and team health</li>
        </ul>
      </div>

      <div class="card">
        <h3>AI Support (Responsible)</h3>
        <ul class="clean">
          <li>Use AI for meeting notes, summaries, and action items</li>
          <li>Support reporting, risk signals, and story clarity</li>
          <li>Apply human oversight to all AI-assisted outputs</li>
        </ul>
      </div>
    </div>
  </div>
...
<section id="curriculum">
  <div class="container" id="section4">
    <h2>2-Day Curriculum</h2>
    <p class="lead">A clear, structured agenda that progresses from fundamentals to applied execution.</p>

    <div class="grid-2">
      <div class="card">
        <h3>Day 1 — Agile & Scrum Core</h3>
        <ul class="clean">
          <li>Agile values, principles, and mindset</li>
          <li>Scrum roles: Product Owner, Scrum Master, Developers</li>
          <li>Scrum events: planning, daily Scrum, review, retro</li>
          <li>Scrum artifacts: product backlog, sprint backlog, increment</li>
          <li>Backlog refinement and story readiness standards</li>
          <li>Hands-on simulation: running key Scrum events</li>
        </ul>
        <div class="small"><b>Outcome:</b> You can run a sprint cycle confidently and correctly.</div>
      </div>

      <div class="card">
        <h3>Day 2 — AI-Enhanced Scrum Master Execution</h3>
        <ul class="clean">
          <li>Facilitation techniques for high-performing teams</li>
          <li>Blocker removal, risk handling, and stakeholder alignment</li>
          <li>Metrics: velocity vs flow, throughput, cycle time basics</li>
          <li>AI tools for: agendas, summaries, story clarity, reporting</li>
          <li>Responsible AI use: verification, bias checks, governance</li>
          <li>Hands-on simulation: real scenarios + coaching practice</li>
        </ul>
        <div class="small"><b>Outcome:</b> You can lead delivery and use AI tools without losing control.</div>
      </div>
    </div>
  </div>
</section>
...
<section>
  <div class="container" id="section6">
    ...
    <div class="card faq">
      <p><strong>Who is this program for?</strong><br>
        Job seekers, career changers, and professionals who want to lead Agile teams using Scrum.
      </p>

      <p><strong>Is AI experience required?</strong><br>
        No. AI is introduced as a practical support tool with strict human oversight.
      </p>

      <p><strong>Will I receive a certificate?</strong><br>
        Yes. A BTMG USA certificate of completion is included.
      </p>

      <p><strong>Can my company enroll a team?</strong><br>
        Yes. Select <strong>Corporate / Team</strong> in the registration form and we will coordinate.
      </p>
    </div>
  </div>
</section>
...
<!-- =========================================================
  CTA + REGISTRATION (Python-style)
========================================================= -->
<section id="register">
  <div class="container cta" id="section5">
    <h2>Ready to Become a Scrum Master with Confidence?</h2>
    <p class="lead">Register now to reserve your seat for the next Agile & AI Scrum Master batch.</p>
    ...
    <div id="reg-form" class="form-wrap">
      ...
      <p class="lead" style="font-size:15px;margin-top:4px">
...
<form action="{{ route('agileandaIscrummaster') }}" method="POST">
    @csrf

    <div class="form-grid">
        <div>
            <label>Full Name</label>
            <input name="agileandaIscrummaster" placeholder="Your full name" required>
        </div>
    ...
    <div class="form-disclaimer mt-4">
        <label class="disclaimer-checkbox">
            ...
            <span class="disclaimer-text">
                ...
                I agree that my information will be used by <strong>BTMGUSA</strong> solely for educational and enrollment purposes.<br>
